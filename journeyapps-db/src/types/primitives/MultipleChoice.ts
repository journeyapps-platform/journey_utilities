import { MultipleChoiceType } from '@journeyapps/parser-schema';
import { DBTypeMixin } from '../Type';

type GConstructor<T extends MultipleChoiceType = MultipleChoiceType> = new (...args: any[]) => T;
...
export class DBMultipleChoiceType extends DBMultipleChoiceTypeMixin(MultipleChoiceType) {}
